...
> **Candidate:** v0.5.0 has completed local qualification but is not published yet.
...
The release candidate passes the complete compiler, CLI, LSP, distributed-home, formatter, and
example-corpus suite with warnings denied. The optimized distribution passes `doctor` and a fresh
