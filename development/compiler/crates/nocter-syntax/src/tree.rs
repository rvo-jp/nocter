...
pub enum NodeKind {
    ...
    ConstantGenericParameter,
    Parameters,
    Parameter,
    ArgumentPackModifier,
    ArgumentPackValueType,
    CallableTail,
    ProvenanceClause,
    Block,
    BlockUseDeclaration,
...
impl NodeKind {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::PrimitiveTypeDeclaration => "primitive_type_declaration",
            ...
            Self::CompileTimeModifier => "compile_time_modifier",
            Self::NoAllocationModifier => "no_allocation_modifier",
            Self::NoTrapModifier => "no_trap_modifier",
            Self::BlockingModifier => "blocking_modifier",
            Self::AsyncModifier => "async_modifier",
            ...
            Self::InterfaceApplication => "interface_application",
            Self::AssociatedBindings => "associated_bindings",
            ...
            Self::TypeGenericParameter => "type_generic_parameter",
            Self::ConstantGenericParameter => "constant_generic_parameter",
            Self::Parameters => "parameters",
            Self::Parameter => "parameter",
            Self::ArgumentPackModifier => "argument_pack_modifier",
            Self::ArgumentPackValueType => "argument_pack_value_type",
            ...
            Self::ForAwaitStatement => "for_await_statement",
            Self::ForBindings => "for_bindings",
            ...
            Self::TypedMappingLiteral => "typed_mapping_literal",
            Self::MappingBody => "mapping_body",
            Self::MappingElement => "mapping_element",
            ...
            Self::ArrayRepeatLiteral => "array_repeat_literal",
            ...
            Self::FutureType => "future_type",
            Self::CallableType => "callable_type",
            Self::ErasedCallableModifier => "erased_callable_modifier",
            ...
            Self::CallablePredicate => "callable_predicate",
