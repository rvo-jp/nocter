...
argument-pack member names, and the canonical physical source layout. It does not parse source,
own diagnostic meaning or semantic identities, or decide whether a source program is valid.
