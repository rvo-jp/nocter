use nocter_model::{
    ...
    InstanceId, InterfaceId, LocalBindingId, ModuleId, NominalTypeId, OpaqueTypeId, PackageId,
    PackageTargetId, ParameterId, RequirementId, TestId, TypeAliasId, VariantId,
};
