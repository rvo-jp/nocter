use nocter_model::{
    AssociatedTypeId, BodyId, BodyNodeId, CallableId, CaptureId, ConformanceId, ConstructionId,
    DeclarationSiteId, DropId, FieldId, GenericParameterId, ImportId, InstanceId, InterfaceId,
