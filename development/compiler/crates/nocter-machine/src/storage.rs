...
pub enum MachineAddressStep {
    Offset(u64),
    /// Adds one already validated compiler-generated byte offset without applying source indexing
    /// bounds. This is reserved for internal layout traversal such as fixed-array destruction.
    OffsetValue(MachineValueId),
    Dereference,
    ViewDereference {
        pointer_offset: u64,
        length_offset: u64,
