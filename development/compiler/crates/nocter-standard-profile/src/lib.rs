...
pub const fn bundled_primitive_source_location(
    ...
    match role {
        ...
        Role::ProcessLifecycleDescriptor => (
            &["internal", "os", "darwin"],
            "process_lifecycle_descriptor_raw",
        ),
        Role::ProcessLifecycleObserve => (
            &["internal", "os", "darwin"],
            "process_lifecycle_observe_raw",
        ),
        ...
        Role::I8FromBits => (&["num"], "i8_from_bits_raw"),
        Role::I8ToBits => (&["num"], "i8_to_bits_raw"),
        Role::I16FromBits => (&["num"], "i16_from_bits_raw"),
        Role::I16ToBits => (&["num"], "i16_to_bits_raw"),
        Role::I32FromBits => (&["num"], "i32_from_bits_raw"),
        Role::I32ToBits => (&["num"], "i32_to_bits_raw"),
        Role::I64FromBits => (&["num"], "i64_from_bits_raw"),
        Role::I64ToBits => (&["num"], "i64_to_bits_raw"),
        ...
        Role::ProcessInstallDescriptor => (&["process"], "install_descriptor_raw"),
        Role::ProcessChangeDirectory => (&["process"], "change_directory_raw"),
        Role::ProcessExec => (&["process"], "exec_process_raw"),
        ...
        Role::FilesystemCanonicalize => (&["internal", "io"], "filesystem_canonicalize_raw"),
        ...
        Role::Syscall3Signed => (&["internal", "os", "darwin"], "syscall3_signed"),
