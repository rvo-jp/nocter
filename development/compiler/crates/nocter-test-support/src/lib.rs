...
primitive func f64_to_bits_raw(value: f64): u64
primitive func f32_floor_raw(value: f32): f32
primitive func f32_ceil_raw(value: f32): f32
primitive func f32_trunc_raw(value: f32): f32
primitive func f32_round_ties_even_raw(value: f32): f32
primitive func f64_floor_raw(value: f64): f64
...
primitive func u64_wrapping_sub_raw(left: u64, right: u64): u64
primitive func u64_wrapping_mul_raw(left: u64, right: u64): u64
primitive func u64_mul_high_raw(left: u64, right: u64): u64
primitive func u64_bit_and_raw(left: u64, right: u64): u64
primitive func u64_bit_or_raw(left: u64, right: u64): u64
primitive func u64_bit_xor_raw(left: u64, right: u64): u64
primitive func u64_rotate_right_raw(value: u64, amount: u64): u64
primitive func u64_leading_zeros_raw(value: u64): u64
construct u8 {
...
#target: \"arm64-darwin\"
noalloc primitive func wall_clock_raw(): (i64, u64, i32)
#target: \"arm64-darwin\"
...
#target: \"arm64-darwin\"
primitive func file_identity_raw(owner: FileOwner): future FileCompletion from static
#target: \"arm64-darwin\"
...
#target: \"arm64-darwin\"
primitive func filesystem_canonicalize_raw(path: &str, destination: &+[u8]): future FileCompletion from static
#target: \"arm64-darwin\"
...
#target: \"arm64-darwin\"
noalloc primitive func file_completion_identity_device_raw(completion: &FileCompletion): u64
#target: \"arm64-darwin\"
noalloc primitive func file_completion_identity_inode_raw(completion: &FileCompletion): u64
#target: \"arm64-darwin\"
