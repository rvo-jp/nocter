...
fn contract(role: PrimitiveRole) -> PrimitiveContract {
    ...
    match role {
        ...
        PrimitiveRole::I8FromBits => make(0, vec![u8()], i8(), private, None, vec![]),
        PrimitiveRole::I8ToBits => make(0, vec![i8()], u8(), private, None, vec![]),
        PrimitiveRole::I16FromBits => make(0, vec![u16()], i16(), private, None, vec![]),
        PrimitiveRole::I16ToBits => make(0, vec![i16()], u16(), private, None, vec![]),
        PrimitiveRole::I32FromBits => make(0, vec![u32()], i32(), private, None, vec![]),
        PrimitiveRole::I32ToBits => make(0, vec![i32()], u32(), private, None, vec![]),
        PrimitiveRole::I64FromBits => make(0, vec![u64()], i64(), private, None, vec![]),
        PrimitiveRole::I64ToBits => make(0, vec![i64()], u64(), private, None, vec![]),
        ...
        PrimitiveRole::FilesystemReadLink | PrimitiveRole::FilesystemCanonicalize => make(
            0,
