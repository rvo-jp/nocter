...
fn prepare_map_arguments(code: &mut Arm64CodeBuilder) {
    ...
    crate::frame_access::load_immediate(
        code,
        argument(2),
        crate::darwin_kernel_abi::DarwinMemoryMapAbi::READ_WRITE_PROTECTION,
        Arm64DataSize::Bits64,
    );
    crate::frame_access::load_immediate(
        code,
        argument(3),
        crate::darwin_kernel_abi::DarwinMemoryMapAbi::PRIVATE_ANONYMOUS_FLAGS,
        Arm64DataSize::Bits64,
    );
    crate::frame_access::load_immediate(
        code,
        argument(4),
        crate::darwin_kernel_abi::DarwinMemoryMapAbi::ANONYMOUS_DESCRIPTOR,
        Arm64DataSize::Bits64,
    );
