...
pub(crate) fn emit_instruction(
    ...
    match *instruction {
        ...
        Arm64SelectedInstruction::IndexAddress {
            ...
            domain,
            check,
        } => crate::address_code::emit_index_address(
            function,
            destination,
            index,
            domain,
        ...
        Arm64SelectedInstruction::ConstructTaskGroupReady {
            available_offset,
            index_offset,
        } => {
            crate::frame_access::load_immediate(
        ...
        Arm64SelectedInstruction::CallDarwinLifecycleDescriptor => context
            .primitives
            .lifecycle()
            .map(|targets| code.call(targets.descriptor()))
            .ok_or(Arm64MaterializationError::MissingLifecyclePrimitiveTarget),
        Arm64SelectedInstruction::CallDarwinLifecycleObserve => context
            .primitives
            .lifecycle()
            .map(|targets| code.call(targets.observe()))
            .ok_or(Arm64MaterializationError::MissingLifecyclePrimitiveTarget),
...
pub enum Arm64MaterializationError {
    ...
    MissingLifecyclePrimitiveTarget,
