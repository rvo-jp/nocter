...
use crate::{
    ...
    Arm64DarwinLifecycleError, Arm64DarwinLifecycleTargets, Arm64DarwinNetworkPrimitiveAbis,
    Arm64DarwinNetworkPrimitiveError, Arm64DarwinNetworkPrimitiveTargets,
    Arm64DarwinProcessServiceError, Arm64DarwinProcessServiceTargets, Arm64ProgramBuilder,
};
...
pub(crate) struct Arm64PrimitiveTargets {
    ...
    lifecycle: Option<Arm64DarwinLifecycleTargets>,
}
...
impl Arm64PrimitiveTargets {
    pub(crate) fn declare(
        ...
        Ok(Self {
            ...
            lifecycle: Arm64DarwinLifecycleTargets::declare(&roles, builder)?,
        })
    }
    ...
    pub(crate) const fn lifecycle(self) -> Option<Arm64DarwinLifecycleTargets> {
        self.lifecycle
    }
    ...
    pub(crate) fn process_finalizers(self) -> impl Iterator<Item = crate::Arm64FunctionId> {
        [
            ...
            self.lifecycle.map(Arm64DarwinLifecycleTargets::finalize),
        ]
        .into_iter()
        .flatten()
    }
...
pub enum Arm64PrimitiveTargetError {
    ...
    Lifecycle(Arm64DarwinLifecycleError),
}
...
impl From<Arm64DarwinLifecycleError> for Arm64PrimitiveTargetError {
    fn from(error: Arm64DarwinLifecycleError) -> Self {
