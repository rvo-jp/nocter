...
closed_role_enum! {
    ...
    pub enum PrimitiveRole {
        ...
        DescriptorWrite,
        /// Opens or returns the process-owned Darwin lifecycle event descriptor.
        ProcessLifecycleDescriptor,
        /// Performs one nonblocking observation of the process lifecycle event source.
        ProcessLifecycleObserve,
        ...
        /// Constructs one generated symbolic-link creation computation.
        ...
        NetworkTlsConnectionCreateHost,
...
impl PrimitiveRole {
    ...
    pub const fn name(self) -> &'static str {
        match self {
            ...
            Self::ProcessLifecycleDescriptor => "process_lifecycle_descriptor",
            Self::ProcessLifecycleObserve => "process_lifecycle_observe",
            ...
            Self::I8FromBits => "i8_from_bits",
            Self::I8ToBits => "i8_to_bits",
            Self::I16FromBits => "i16_from_bits",
            Self::I16ToBits => "i16_to_bits",
            Self::I32FromBits => "i32_from_bits",
            Self::I32ToBits => "i32_to_bits",
            Self::I64FromBits => "i64_from_bits",
            Self::I64ToBits => "i64_to_bits",
    ...
    const fn network_connection_name(self) -> &'static str {
        match self {
            ...
            Self::NetworkConnectionCreateHost => "network_connection_create_host",
            Self::NetworkTlsConnectionCreate => "network_tls_connection_create",
            Self::NetworkTlsConnectionCreateHost => "network_tls_connection_create_host",
            Self::NetworkTlsConnectionMatchesApplicationProtocol => {
