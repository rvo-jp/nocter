...
const REVIEWED_STANDARD_DEPENDENCIES: &[(&str, &str)] = &[
    ("archive", "fixed"),
    ("archive", "internal/safety"),
    ("archive", "io"),
    ("archive", "str"),
    ("archive", "string"),
    ("archive", "vec"),
    ("base64", "internal/mem"),
    ("base64", "internal/safety"),
    ("base64", "string"),
    ("base64", "vec"),
    ("bytes", "internal/bytes"),
    ("checksum", "internal/safety"),
    ...
    ("config/environment", "process"),
    ("config/json", "config"),
    ("config/json", "internal/ptr"),
    ("config/json", "json"),
    ("digest", "fmt"),
    ("digest", "hash"),
    ("digest", "hex"),
    ("digest", "internal/ptr"),
    ("digest", "internal/safety"),
    ("digest", "order"),
    ("digest", "ptr"),
    ("digest", "str"),
    ("digest", "string"),
    ...
    ("fs", "time"),
    ("fs", "vec"),
    ("hash", "internal/character"),
    ("hash", "internal/entropy"),
    ("hash", "internal/ptr"),
    ("hash", "internal/safety"),
    ("hash", "num"),
    ("hash", "ptr"),
    ("hash", "string"),
    ("hash", "vec"),
    ...
    ("http", "url"),
    ("http", "vec"),
    ("internal/entropy", "internal/os/darwin"),
    ("internal/entropy", "internal/ptr"),
    ("internal/entropy", "ptr"),
    ("internal/io", "internal/os"),
    ("internal/io", "internal/os/darwin"),
    ("internal/net", "internal/net/darwin"),
    ("internal/net", "internal/net/model"),
    ("internal/net", "internal/os"),
    ("internal/net", "internal/ptr"),
    ("internal/net", "internal/task"),
    ("internal/net", "internal/time"),
    ("internal/net", "ptr"),
    ("internal/net", "time"),
    ("internal/net/darwin", "internal/net/model"),
    ("internal/net/darwin", "internal/bytes"),
    ("internal/net/darwin", "internal/os"),
    ("internal/net/darwin", "internal/os/darwin"),
    ("internal/net/darwin", "internal/ptr"),
    ("internal/net/darwin", "ptr"),
    ("internal/net/model", "internal/os"),
    ("internal/notify", "internal/io"),
    ("internal/notify", "internal/os/darwin"),
    ("internal/notify", "internal/shared"),
    ("internal/notify", "internal/task"),
    ("internal/notify", "ptr"),
    ("internal/os/darwin", "internal/os"),
    ("internal/os/darwin", "ptr"),
    ("internal/percent", "internal/ascii"),
    ("internal/percent", "scan"),
    ...
    ("internal/shared", "internal/mem"),
    ("internal/shared", "internal/ptr"),
    ("internal/shared", "internal/safety"),
    ("internal/shared", "mem"),
    ...
    ("io/buffer", "string"),
    ("io/buffer", "vec"),
    ("io/stream", "internal/safety"),
    ("io/stream", "io"),
    ("io/stream", "io/buffer"),
    ("io/stream", "iter/asynchronous"),
    ("io/stream", "scan"),
    ("io/stream", "string"),
    ("io/stream", "vec"),
    ("iter", "internal/ptr"),
    ...
    ("random", "base64"),
    ("random", "bytes"),
    ("random", "internal/entropy"),
    ("random", "internal/ptr"),
    ("random", "internal/safety"),
    ("random", "ptr"),
    ("random", "string"),
    ("random", "vec"),
    ("scan", "bytes"),
    ("scan", "internal/safety"),
    ("set", "hash"),
    ("set", "internal/table"),
    ("set", "iter"),
    ("set", "mem"),
    ("session", "base64"),
    ("session", "hash"),
    ("session", "internal/ptr"),
    ("session", "internal/safety"),
    ("session", "order"),
    ("session", "ptr"),
    ("session", "random"),
    ("session", "str"),
    ("session", "string"),
    ("slice", "internal/ptr"),
    ("slice", "internal/safety"),
    ("slice", "order"),
    ("str", "internal/character"),
    ("str", "internal/mem"),
    ("str", "internal/ptr"),
    ("str", "internal/safety"),
    ("str", "internal/unicode"),
    ("str", "internal/utf8"),
    ("str", "iter"),
    ("str", "mem"),
    ("str", "string"),
    ...
    ("store", "internal/mem"),
    ("store", "internal/ptr"),
    ("store", "internal/safety"),
    ("store", "io"),
    ("store", "iter"),
    ("store", "scan"),
    ("store", "string"),
    ("store", "vec"),
    ("string", "internal/character"),
    ("string", "internal/mem"),
    ("string", "internal/ptr"),
    ("string", "internal/safety"),
    ("string", "internal/utf8"),
    ("string", "mem"),
    ("sync", "internal/notify"),
    ("sync", "internal/ptr"),
    ("sync", "internal/safety"),
    ("sync", "internal/shared"),
    ("sync", "ptr"),
    ("service", "sync"),
    ("service", "task"),
    ("service", "fixed"),
    ("service", "internal/os/darwin"),
    ("service", "internal/task"),
    ("task", "internal/safety"),
    ("task", "internal/task"),
    ("task", "time"),
    ("task", "vec"),
    ("time", "internal/time"),
