...
pub use checked::{
    ...
    CheckedCallableErasure, CheckedCallableProvenance, CheckedCapture, CheckedClosure,
    CheckedClosureCapture, CheckedClosureProvenance, CheckedComparison, CheckedComparisonPlan,
