...
impl BodyRule {
    ...
    pub const fn code(self) -> DiagnosticCode {
        match self {
            Self::TypeMismatch => DiagnosticCode::E0370,
            Self::ImplicitMove => DiagnosticCode::E0371,
            ...
            Self::UnknownField => DiagnosticCode::E0379,
            Self::InaccessibleField => DiagnosticCode::E0380,
            Self::PartialMoveThroughDrop => DiagnosticCode::E0381,
            Self::InvalidLoopControl => DiagnosticCode::E0382,
            Self::InvalidExplicitDrop => DiagnosticCode::E0383,
            Self::InvalidAssignmentTarget => DiagnosticCode::E0384,
            Self::InvalidReinitialization => DiagnosticCode::E0385,
            Self::InvalidCompoundAssignment => DiagnosticCode::E0386,
            Self::InvalidBorrowSource => DiagnosticCode::E0410,
            Self::InvalidReadWriteBorrow => DiagnosticCode::E0387,
            Self::InvalidIndexOperation => DiagnosticCode::E0388,
            Self::InvalidComparisonOperation => DiagnosticCode::E0389,
            Self::InvalidCall => DiagnosticCode::E0390,
            Self::InvalidConstruction => DiagnosticCode::E0391,
            Self::InvalidOutcomeOperation => DiagnosticCode::E0392,
            Self::InvalidPatternOperation => DiagnosticCode::E0393,
            Self::InvalidMatchCoverage => DiagnosticCode::E0394,
            Self::InvalidValueProvenance => DiagnosticCode::E0395,
            Self::ConflictingLoan => DiagnosticCode::E0396,
            Self::BorrowedPlaceMutation => DiagnosticCode::E0397,
            Self::InvalidStorageEscape => DiagnosticCode::E0398,
            Self::InvalidAllocationContext => DiagnosticCode::E0399,
            Self::InvalidInterpolation => DiagnosticCode::E0400,
            Self::InvalidSpreadAcquisition => DiagnosticCode::E0401,
            Self::InvalidSpreadIterator => DiagnosticCode::E0402,
            Self::InvalidSpreadElement => DiagnosticCode::E0403,
            Self::InvalidCollectionAcquisition => DiagnosticCode::E0404,
            Self::InvalidCollectionIterator => DiagnosticCode::E0405,
            Self::InvalidBodyTypeUse => DiagnosticCode::E0406,
            ...
            Self::NoTrapContractViolation => DiagnosticCode::E0425,
    ...
    fn message_and_help(self) -> (&'static str, &'static str) {
        match self {
            ...
            Self::NoTrapContractViolation => (
                "operation may trap inside a `notrap` contract",
                "remove the trapping path, use a recoverable operation, or remove `notrap` from the callable contract",
            ),
            Self::BlockingContractViolation => (
    ...
    fn operation_message(self) -> (&'static str, &'static str) {
        match self {
            ...
            Self::InvalidValueProvenance => (
                "value carries storage outside its declared provenance bound",
                "derive the value only from origins permitted by this result, argument, receiver, or local contract",
            ),
            Self::ConflictingLoan => (
            ...
            Self::InvalidArgumentPackUse => (
                ...
                "use `items.len()`, consuming `for item in items`, or sole tail forwarding `target(...items)`",
            ),
