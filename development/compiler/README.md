...
- [The latest completed milestone](../milestones/v0.21.0.md) owns its scope and completion gates;
  [the latest publication record](../releases/v0.21.0.md) owns frozen release evidence; [the
