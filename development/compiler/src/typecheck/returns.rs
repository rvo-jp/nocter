...
use super::diagnostics::{
    ...
    region_binding_escape_diagnostic, region_return_escape_diagnostic,
...
pub(in crate::typecheck) use borrow_returns::function_declaration_location;
...
pub(super) fn check_return_types(
    ...
    for item in &ast.items {
        match item {
            ...
            Item::Instance(instance) => check_instance_member_return_types(
                sources,
                instance,
                resolved,
                diagnostics,
