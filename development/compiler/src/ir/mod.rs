...
pub(crate) use model::{
    ...
    I32Location, I32Value, Instruction, IntegerBinaryOperator, IrModule, OutcomeFailureMode,
    ScalarArgument, SliceElementAddressKind, SliceElementIndex, SliceLocation, SliceValue,
