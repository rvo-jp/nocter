...
pub(super) fn lower_i32_binary_expression_to_location(
    binary: &BinaryExpr,
...
pub(super) fn lower_i32_binary_expression_to_location_with_temporaries(
    binary: &BinaryExpr,
    destination: I32Location,
    context: &LoweringContext,
...
pub(super) fn lower_i32_expression_to_value(
    expression: &Expr,
    context: &LoweringContext,
    temporaries: &mut TemporaryAllocator,
...
pub(super) fn lower_i32_negate_expression_to_location_with_temporaries(
    unary: &UnaryExpr,
    destination: I32Location,
    context: &LoweringContext,
    temporaries: &mut TemporaryAllocator,
...
pub(super) fn i32_unary_negate_requires_runtime(unary: &UnaryExpr) -> bool {
    unary.operator == UnaryOperator::Negate
        && !expression_is_unsigned_integer_literal(&unary.operand)
}

pub(super) fn expression_is_unsigned_integer_literal(expression: &Expr) -> bool {
    match expression {
...
pub(super) fn lower_u8_expression_to_value(
    expression: &Expr,
    context: &LoweringContext,
    temporaries: &mut TemporaryAllocator,
...
pub(super) fn lower_u8_binary_expression_to_location(
    binary: &BinaryExpr,
...
pub(super) fn lower_u8_binary_expression_to_location_with_temporaries(
    binary: &BinaryExpr,
    destination: U8Location,
    context: &LoweringContext,
    temporaries: &mut TemporaryAllocator,
...
pub(super) fn lower_i32_conversion_expression_to_value(
...
pub(super) fn lower_usize_conversion_expression_to_value(
    conversion: &TypeConversionExpr,
    context: &LoweringContext,
    temporaries: &mut TemporaryAllocator,
...
pub(super) fn type_conversion_target_is(
    conversion: &TypeConversionExpr,
    context: &LoweringContext,
    expected: Type,
) -> bool {
...
pub(super) fn lower_usize_binary_expression_to_location(
    binary: &BinaryExpr,
...
pub(super) fn lower_usize_binary_expression_to_location_with_temporaries(
    binary: &BinaryExpr,
    destination: UsizeLocation,
    context: &LoweringContext,
    temporaries: &mut TemporaryAllocator,
...
pub(super) fn lower_usize_expression_to_value(
    expression: &Expr,
    context: &LoweringContext,
    temporaries: &mut TemporaryAllocator,
) -> Result<LoweredUsizeValue, Vec<Diagnostic>> {
...
pub(super) fn lower_bool_expression_to_branch(
    expression: &Expr,
...
pub(super) fn lower_bool_expression_to_branch_with_temporaries(
    expression: &Expr,
    then_instructions: Vec<Instruction>,
    else_instructions: Vec<Instruction>,
    context: &LoweringContext,
...
pub(super) fn lower_bool_comparison_to_value_with_temporaries(
    binary: &BinaryExpr,
    context: &LoweringContext,
    diagnostic_code: &'static str,
    temporaries: &mut TemporaryAllocator,
...
pub(super) fn lower_bool_comparison_operand_to_value_with_temporaries(
    expression: &Expr,
    context: &LoweringContext,
    diagnostic_code: &'static str,
    temporaries: &mut TemporaryAllocator,
...
pub(super) fn materialize_computed_str_value(
    value: StrValue,
...
pub(super) fn lower_i32_comparison_to_value_with_temporaries(
    binary: &BinaryExpr,
    context: &LoweringContext,
    diagnostic_code: &'static str,
    temporaries: &mut TemporaryAllocator,
...
pub(super) fn lower_usize_comparison_to_value_with_temporaries(
    binary: &BinaryExpr,
    context: &LoweringContext,
    diagnostic_code: &'static str,
    temporaries: &mut TemporaryAllocator,
...
pub(super) fn lower_u8_comparison_to_value_with_temporaries(
    binary: &BinaryExpr,
    context: &LoweringContext,
    diagnostic_code: &'static str,
    temporaries: &mut TemporaryAllocator,
...
pub(super) fn lower_u8_comparison_condition(
    binary: &BinaryExpr,
    context: &LoweringContext,
    diagnostic_code: &'static str,
...
pub(super) fn lower_bool_unary_value(
    unary: &UnaryExpr,
    context: &LoweringContext,
    diagnostic_code: &'static str,
) -> Result<BoolValue, Vec<Diagnostic>> {
...
pub(super) fn lower_bool_binary_value(
    binary: &BinaryExpr,
    context: &LoweringContext,
    diagnostic_code: &'static str,
) -> Result<BoolValue, Vec<Diagnostic>> {
...
pub(super) fn lower_bool_logical_value(
    binary: &BinaryExpr,
    context: &LoweringContext,
    diagnostic_code: &'static str,
) -> Result<BoolValue, Vec<Diagnostic>> {
...
pub(super) fn lower_bool_comparison_condition(
    binary: &BinaryExpr,
    context: &LoweringContext,
    diagnostic_code: &'static str,
) -> Result<BoolValue, Vec<Diagnostic>> {
...
pub(super) fn lower_bool_comparison_operand(
    expression: &Expr,
    context: &LoweringContext,
    diagnostic_code: &'static str,
) -> Result<BoolValue, Vec<Diagnostic>> {
...
pub(super) fn lower_str_comparison_condition(
    binary: &BinaryExpr,
    context: &LoweringContext,
    diagnostic_code: &'static str,
) -> Result<BoolValue, Vec<Diagnostic>> {
...
pub(super) fn lower_i32_comparison_condition(
    binary: &BinaryExpr,
    context: &LoweringContext,
    diagnostic_code: &'static str,
) -> Result<BoolValue, Vec<Diagnostic>> {
...
pub(super) fn lower_usize_comparison_condition(
    binary: &BinaryExpr,
    context: &LoweringContext,
    diagnostic_code: &'static str,
) -> Result<BoolValue, Vec<Diagnostic>> {
...
pub(super) fn i32_comparison_operator(
    operator: BinaryOperator,
    diagnostic_code: &'static str,
...
pub(super) fn str_comparison_operator(
    operator: BinaryOperator,
    diagnostic_code: &'static str,
