...
pub(super) use primitives::{
    ...
    primitive_current_allocation_state_call, primitive_env_count_raw_call,
    primitive_env_entry_raw_call, primitive_exit_raw_call, primitive_from_ref_call,
    ...
    primitive_str_subview_call, primitive_view_len_call, primitive_write_bytes_raw_call,
