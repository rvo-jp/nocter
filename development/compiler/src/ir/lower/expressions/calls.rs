...
pub(super) use primitives::{
    ...
    lower_copy_str_to_ptr_primitive_call, lower_exit_raw_primitive_call,
    ...
    primitive_open_read_raw_call, primitive_pointee_size_call, primitive_read_bytes_raw_call,
