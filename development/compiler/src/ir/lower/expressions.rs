...
use super::bindings::{
    LoopControlContext, LoweredFallbackResult, lower_aggregate_optional_otherwise_to_location,
    lower_assignment, lower_bool_optional_otherwise_to_location,
    lower_fallback_block_with_result_mode, lower_i32_optional_otherwise_to_location,
...
use super::functions::{
    ...
    lower_aggregate_drop_instructions, lower_aggregate_return_expression_to_location,
...
mod call_arguments;
mod calls;
pub(in crate::ir::lower) use calls::{describe_type, validate_known_call_success_return_passing};
...
use calls::{
    ...
    lower_str_subview_primitive_call_to_location, lower_u8_normal_call, lower_usize_normal_call,
    lower_view_len_primitive_call_to_value, lower_view_pointer_primitive_call_to_value,
    lower_void_normal_call, primitive_addr_call, primitive_arg_count_raw_call,
    primitive_arg_raw_call, primitive_bytes_from_str_call, primitive_close_fd_raw_call,
    primitive_copy_ptr_to_ptr_call, primitive_copy_str_to_ptr_call,
    ...
    primitive_str_subview_call, primitive_view_len_call, primitive_view_pointer_call,
