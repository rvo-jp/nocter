...
pub(in crate::driver::buildability) fn catch_block_runtime_shape_is_buildable(
    block: &Block,
    resolved: &ResolveOutput,
    resolved_sources: &ResolvedSources<'_>,
    typecheck_facts: &TypecheckFacts,
...
pub(in crate::driver::buildability) fn catch_block_leading_statement_runtime_shape_is_buildable(
    statement: &Stmt,
    resolved: &ResolveOutput,
    resolved_sources: &ResolvedSources<'_>,
    typecheck_facts: &TypecheckFacts,
...
pub(in crate::driver::buildability) fn catch_block_terminal_statement_runtime_shape_is_buildable(
    statement: &Stmt,
    resolved: &ResolveOutput,
    resolved_sources: &ResolvedSources<'_>,
    typecheck_facts: &TypecheckFacts,
