...
pub(in crate::driver::buildability) fn type_expr_is_error_parameter_for_sources(
    ty: &TypeExpr,
...
pub(in crate::driver::buildability) fn type_expr_resolves_to_borrow_inner<'a, F>(
    ty: &TypeExpr,
    fallback_resolved: &'a ResolveOutput,
    resolver: &F,
    resolving_names: &mut HashSet<String>,
