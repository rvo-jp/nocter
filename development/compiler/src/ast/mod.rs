...
pub(crate) use visit::{
    closure_expression_by_span, visit_block_expressions_without_nested_closures,
    visit_block_statements_without_nested_closures, visit_expression, visit_file_expressions,
    visit_file_statements,
};
