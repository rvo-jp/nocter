...
The release gate covers the complete compiler suite, formatting, Clippy with warnings denied,
public documentation generation, optimized local packaging, installed-home `doctor`, packaged-home
runtime execution, and archive-content inspection. Repository and packaged homes must agree across
all Phase 0 through Phase 10 acceptance surfaces.

See the [v0.3.0 release record](../docs/v0.3.0.md) for completion criteria, verification boundaries,
