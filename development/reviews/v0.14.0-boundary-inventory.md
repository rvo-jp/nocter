...
The checking/lowering, target/source-projection, and filesystem/editor-version edges have been
removed. The remaining open edge is `nocter-machine -> nocter-target-program`; closing the MIR
backend environment will remove it without transferring target-program storage into another crate.
