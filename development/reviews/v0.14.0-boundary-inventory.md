...
**Status: complete first-pass inventory (2026-08-23).**
...
there solely for integration fixtures. The remaining open review finding concerns MIR's navigation
through executable storage while MIR itself is being built, not a machine dependency.
