...
[release preparation](v0.18.0-release-preparation.md) are complete, and v0.18.0 is published. The
milestone owns scope and completion criteria; the handoff owns only the next concrete action.
