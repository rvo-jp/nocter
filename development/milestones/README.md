...
The active milestone is [v0.8.0](v0.8.0.md). Phase 0 establishes type-owned borrow coercion from
source syntax through semantic plans, ownership, lowering, standard-library views, and editor
tooling.
