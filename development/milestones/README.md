...
the existing `as` expression. Phase 2 completed contract freeze and local release qualification.
The qualified archive was published and audited on 2026-08-08. No later phase is active yet.
