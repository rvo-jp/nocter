...
The active milestone is [v0.14.0](v0.14.0.md). Phases 0 through 2 completed typed compile-unit
identity, checker-owned partial typed HIR, and indexed editor projection. Phase 3 is replacing
AST-shaped buildability and lowering with checked control-flow MIR. The milestone does not add
public language features.
