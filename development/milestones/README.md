...
The current milestone record is [v0.9.0](v0.9.0.md). Phase 0 is implementing portable whole-stream
byte and UTF-8 collection as shared `Reader` default methods, plus shared text output for `Writer`.
The published baseline remains v0.8.0.
