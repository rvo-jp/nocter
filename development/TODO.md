...
Nocter v0.58.0 is published and externally audited. The v0.59.0 Integrity-Checked Binary Records
candidate is complete and qualified, publication is authorized, and public metadata now selects
v0.59.0. The retained archive and measured identities are recorded in the release-preparation
record.

## Next Work

Commit this publication metadata, create annotated tag `v0.59.0`, fast-forward `main`, and publish
