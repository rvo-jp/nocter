...
4. The active [milestone](../milestones/v0.19.0.md) or completed [review](../reviews/README.md) only
...
| Active scope and completion gates | `development/milestones/v0.19.0.md` |
