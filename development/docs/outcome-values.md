...
Public value, ownership, and control-flow semantics belong to the specification. The active
completion gate belongs to the [v0.3.0 Development Contract](v0.3.0.md).
