...
whole-local fixed array assignment, constant and variable index reads and simple
writes are buildable for the current scalar/view element subset, with numeric
constant index compound assignment for `i32`, `u8`, and `usize`.
...
- broader fixed-array behavior: variable index compound assignment, zero-sized local
