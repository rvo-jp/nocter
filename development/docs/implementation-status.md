...
bindings, and whole-local replacement now drop only the active single
...
- payload-carrying enum non-copy aggregate payload binding, temporary-pattern
  control, and multi-field droppable payload cleanup
