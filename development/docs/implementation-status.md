...
`u8`, `usize`, `bool`, `&str`, slice views, and copy aggregate payloads.
...
payloads. Temporary-pattern control and non-copy aggregate payload binding
...
- payload-carrying enum non-copy aggregate payload binding and
  temporary-pattern control
