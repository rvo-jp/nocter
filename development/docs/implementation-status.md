...
zero-length literal bindings, fixed array local copy bindings, matching fixed
array call-result bindings, fixed array value parameters, direct
literal/local/call-result fixed array returns, whole-local fixed array
...
- broader fixed-array behavior: zero-sized fixed array copy/assignment/call/return
  paths, move-only element arrays, and general array runtime behavior
