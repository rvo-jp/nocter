...
`bool`, `&str`, slice views, and copy aggregate payloads.
...
control-flow completion. Broader pattern target expressions and non-copy
aggregate payload binding remain separate work.
