...
writes are buildable for the current scalar/view element subset, with constant
...
- broader fixed-array behavior: zero-sized local arrays, move-only element
  arrays, and general array runtime behavior
