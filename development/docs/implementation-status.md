...
statement/value-expression arm bindings over existing values for `i32`, `u8`,
`usize`, `bool`, and `&str` payloads. Temporary-pattern control,
...
- payload-carrying enum aggregate/slice/non-copy payload binding,
  temporary-pattern control, and active payload drop cleanup
