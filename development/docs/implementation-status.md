...
whole-local fixed array assignment, and constant index reads/writes are
buildable for the current scalar/view element subset, with numeric constant
...
- broader fixed-array behavior: variable index reads/writes, zero-sized local
