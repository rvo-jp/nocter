...
supported binding, whole-local assignment, argument, return, and aggregate-field
initializer positions, fixed array value parameters including zero-length
values, direct fixed array literal value arguments including zero-length literal
