...
| Released v0.4.0 completion and qualification | `docs/v0.4.0.md` |
| v0.5.0 release-candidate completion and qualification | `docs/v0.5.0.md` |
...
in the active release record; focused documents own design and concrete acceptance behavior. `v0.3.0.md` and
`v0.2.0.md` are historical release records and do not receive new work items.

## Update Triggers

- Candidate scope, qualification, non-goal, or publication state changed: update `v0.5.0.md`.
