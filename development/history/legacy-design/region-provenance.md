...
foundation. Public
semantics belong to [Memory, Regions, and Allocators](../../../spec/language/memory-and-regions.md), and
the completed gate belongs to the [v0.3.0 Release Record](../release-audits/v0.3.0.md).
