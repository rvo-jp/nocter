...
[string and view specification](../../../spec/language/sequences-and-text.md), and receiver
selection belongs in the [borrow-coercion specification](../../../spec/language/borrow-coercions.md).
