...
The [checked-program](pipeline/checked-program.md),
[target/executable/MIR](pipeline/target-program.md), and
[machine/native](pipeline/machine-program.md) documents define only the contracts spanning adjacent
...
The [semantic presentation boundary](pipeline/semantic-presentation.md) owns compiler-to-editor
rendering rules. The [incremental computation boundary](pipeline/incremental-computation.md) owns the
