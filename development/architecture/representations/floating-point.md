...
This document owns the cross-crate representation contract for `f32` and `f64`. Public behavior
belongs to the corresponding specification and checked standard-library contracts.
