...
[execution-contract boundary](../contracts/execution.md) owns how checking proves that invariant. An
...
classification belong to the [execution-contract boundary](../contracts/execution.md), not this frame
