...
`std/http/index.nct`, observable HTTP behavior belongs to
`std/http/README.md`, and asynchronous execution semantics belong to the
[Asynchronous Computation Boundary](asynchronous-computation.md).
...
| Public declarations | `std/http/index.nct` | compiler, editor, and applications |
