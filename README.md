...
[Download nocter-v0.48.0-arm64-darwin.tar.gz](https://github.com/rvo-jp/nocter/releases/download/v0.48.0/nocter-v0.48.0-arm64-darwin.tar.gz)
...
The v0.48.0 compiler parses, checks, builds, and runs the supported language on `arm64-darwin` and
