...
```sh
tar -xzf nocter-v0.12.0-arm64-darwin.tar.gz -C "$HOME"
...
The v0.12.0 compiler parses, checks, builds, and runs the supported language on
...
The [language specification](spec/README.md) describes the current v0.12.0
language. The `v0.12.0` repository tag preserves the exact published compiler,
