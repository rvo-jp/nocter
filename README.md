...
[Download nocter-v0.10.0-arm64-darwin.tar.gz](https://github.com/rvo-jp/nocter/releases/download/v0.10.0/nocter-v0.10.0-arm64-darwin.tar.gz)
...
```sh
tar -xzf nocter-v0.10.0-arm64-darwin.tar.gz -C "$HOME"
...
The v0.10.0 compiler parses, checks, builds, and runs the supported language on
...
The [language specification](spec/README.md) describes the current v0.10.0
language. The `v0.10.0` repository tag preserves the exact published compiler,
