...
[Download nocter-v0.63.0-arm64-darwin.tar.gz](https://github.com/rvo-jp/nocter/releases/download/v0.63.0/nocter-v0.63.0-arm64-darwin.tar.gz)
...
```sh
tar -xzf nocter-v0.63.0-arm64-darwin.tar.gz -C "$HOME"
...
```sh
nocter install nocter-v0.63.0-arm64-darwin.tar.gz \
  --sha256 93a3c9bb6238d73dbbcc0aca24f2c93d71e32f252b31f1a2f24d528e0b264697
```
...
The v0.63.0 compiler parses, checks, builds, and runs the supported language on `arm64-darwin` and
