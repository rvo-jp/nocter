...
[Download nocter-v0.71.0-arm64-darwin.tar.gz](https://github.com/rvo-jp/nocter/releases/download/v0.71.0/nocter-v0.71.0-arm64-darwin.tar.gz)
...
```sh
tar -xzf nocter-v0.71.0-arm64-darwin.tar.gz -C "$HOME"
...
```sh
nocter install nocter-v0.71.0-arm64-darwin.tar.gz \
  --sha256 b71b8adebc9d4bd2cfe8383d47e62a058b9f1bac1a71131d6407acac435754f8
```
...
The v0.71.0 compiler parses, checks, builds, and runs the supported language on `arm64-darwin` and
