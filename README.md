...
[Download nocter-v0.68.0-arm64-darwin.tar.gz](https://github.com/rvo-jp/nocter/releases/download/v0.68.0/nocter-v0.68.0-arm64-darwin.tar.gz)
...
```sh
tar -xzf nocter-v0.68.0-arm64-darwin.tar.gz -C "$HOME"
...
```sh
nocter install nocter-v0.68.0-arm64-darwin.tar.gz \
  --sha256 36c26be4910a07bc7cb36ffbec30c36d4280f8d1a18a72da40d1775ecbc3a775
```
...
The v0.68.0 compiler parses, checks, builds, and runs the supported language on `arm64-darwin` and
