...
[Download nocter-v0.7.0-arm64-darwin.tar.gz](https://github.com/rvo-jp/nocter/releases/download/v0.7.0/nocter-v0.7.0-arm64-darwin.tar.gz)
...
```sh
tar -xzf nocter-v0.7.0-arm64-darwin.tar.gz -C "$HOME"
...
The v0.7.0 compiler parses, checks, builds, and runs the supported language on
...
the current v0.7.0 language; the `v0.7.0` repository tag preserves the exact
