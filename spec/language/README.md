...
These chapters define Nocter source syntax and program semantics. Their order is editorial; every
rule has one owning chapter and cross-topic chapters link to that authority.
...
- [Callable Values and Interface Default Methods](callables.md)
