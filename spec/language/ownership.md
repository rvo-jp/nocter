...
[Drop and Test Declarations](syntactic-grammar.md#drop-and-test-declarations) and the common
[statement grammar](syntactic-grammar.md#statements).
...
[Expression Precedence](syntactic-grammar.md#expression-precedence).
...
- Optional and fallible return layers are constructed by
  [recursive outcome injection](errors-and-optionals.md#recursive-outcome-injection).
...
The detailed provenance source kinds are specified in [Strings, Arrays, Views, and Pointers](sequences-and-text.md#borrow-like-provenance).
