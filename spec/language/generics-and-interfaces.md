...
[Strings, Arrays, Views, and Pointers](sequences-and-text.md). Generic instance
...
[Construction Surfaces](construction.md).
...
[Interfaces](syntactic-grammar.md#interfaces),
[Instance Interface Implementations](syntactic-grammar.md#instance-interface-implementations), and
[Types](syntactic-grammar.md#types).
...
Interface Default Methods](callables.md).
