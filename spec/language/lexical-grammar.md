...
[Syntactic Grammar](syntactic-grammar.md#notation). The enclosing production chooses whether the
list may be empty.
...
- The finite contextual spellings and their parser positions are defined by the single table in
  [Syntactic Grammar](syntactic-grammar.md#contextual-spellings). They remain identifier-shaped
...
- An interpolated string source form is an expression-level construct, not the non-interpolated
  ...
  [Strings, Arrays, Views, and Pointers](sequences-and-text.md#string-interpolation).
