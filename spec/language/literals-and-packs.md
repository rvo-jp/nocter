...
[Expansion Operators](#expansion-operators). The selected iterator must also satisfy the
...
The language extends the same compiler-owned pack model with keyed entries.
...
[Associative Collections](../../std/map/README.md).
