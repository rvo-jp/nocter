...
- Build modes must not disable these trap checks; see [Safety Checks and Build Modes](control-flow.md#safety-checks-and-build-modes).
...
[contextual expected-type boundary](values-and-types.md#contextual-expected-types) is checked
