...
The entry source form is defined by [Instances](syntactic-grammar.md#instances).
...
[Contextual Expected Types](values-and-types.md#contextual-expected-types) boundaries. Grouping and
