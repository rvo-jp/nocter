...
This working tree specifies the adopted v0.18.0 Phase 0 language contract. v0.17.0 remains the
latest published release. The [release index](../releases/README.md) owns current publication and
download status, and repository tags preserve the exact specification for every published release.
