...
This working tree specifies the prepared v0.16.0 release candidate. It is not a published release.
The [release index](../releases/README.md) owns publication and download status; the v0.15.0 tag
preserves the latest published specification until v0.16.0 is released.
