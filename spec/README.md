...
This working tree specifies the active v0.25.0 candidate, including the v0.20.0
...
values. v0.25.0 adds the source-visible `noalloc` callable guarantee. The latest published release
remains v0.24.0.
