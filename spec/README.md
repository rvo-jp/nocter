...
This working tree specifies the completed v0.12.0 candidate language. The published compatibility
boundary remains v0.11.0 until v0.12.0 is locally qualified, separately authorized, and published.
