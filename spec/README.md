...
This working tree specifies and implements the v0.18.0 release-candidate language contract. Phases
0 through 2 changed the source language; Phase 3 changed compiler architecture only. v0.17.0
remains the latest published release. The [release index](../releases/README.md) owns publication
and download status, and repository tags preserve the exact specification for every published
release.
