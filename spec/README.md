...
This working tree specifies the v0.19.0 release candidate. v0.18.0 remains the latest published
release until publication is completed. The [release index](../releases/README.md) owns current
publication and download status, and repository tags preserve the exact specification for every
published release.
