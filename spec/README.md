...
- [Synchronous Subprocesses](30-subprocesses.md) — v0.30.0 source-tree contract
...
This working tree retains the published v0.29.0 language contract, including the v0.20.0
...
current development tree additionally defines the v0.30.0 owning synchronous-subprocess contract;
published v0.29.0 artifacts do not contain that addition.
