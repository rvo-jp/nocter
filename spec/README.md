...
This working tree specifies the completed and locally qualified v0.12.0 candidate language. The
published compatibility boundary remains v0.11.0 until v0.12.0 is separately authorized and
published. The [release index](../releases/README.md) owns current publication and download status,
