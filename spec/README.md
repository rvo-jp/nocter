...
chapters. The [v0.3.0 Phase 0](../development/docs/v0.3.0.md) implementation gate is complete and
Phase 1 Typed Literal Core is active on `develop`; this does not make v0.3.0 a released language
version. A later v0.3.0 design is not buildable until its own stated gate passes.
