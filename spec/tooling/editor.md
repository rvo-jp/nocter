...
Keyed-pack and mapping-literal tooling presents one key/value entry contract. Hover and
...
The compiler-owned keyword set is deliberately contextual and closed:
