...
source identity rules are specified in [Modules and Use Declarations](../language/modules.md).
...
defined by [Native Testing](testing.md#ci-result-contract). The command exits zero only
...
[Diagnostics](diagnostics.md#machine-readable-json-diagnostics).
