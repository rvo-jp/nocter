...
- `valid/` means source-valid for `check` under the current specification and compiler candidate.
...
The corpus is an external stability suite for the current source-tree contract. It covers lexer,
parser, compile-unit loading, import resolution, type
...
- default `main` entry
- doc comments and compiler-backed editor documentation
