...
This document records the implementation status of the distributed
`.nocter/std` tree. The public standard-library specification lives in
...
spec, then update `.nocter/std`, tests, and this implementation status.
...
2. Add or update `.nocter/std` declarations and implementations.
