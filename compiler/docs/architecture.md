...
- simple aggregate slot reassignment from supported struct literals, direct or indirect normal aggregate calls, propagated fallible direct aggregate calls, propagated fallible indirect aggregate calls, and copy struct local aggregate slots
