...
- optional values
- general aggregate value expressions outside the supported struct-literal, call-result, slot-copy, explicit-move, explicit-drop, and borrow paths; arrays, views, pointers, methods, traits, generics, automatic ownership lowering, scope-end drop insertion, and replacement drop glue
