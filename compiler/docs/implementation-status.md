...
| `lsp` | partial | n/a | partial | n/a | partial | Minimal JSON-RPC server supports initialize, workspace root recording, shutdown, exit, full document sync, stale version rejection, open-document import reuse, stale diagnostic clearing, UTF-16 diagnostic positions, and publishDiagnostics. |
