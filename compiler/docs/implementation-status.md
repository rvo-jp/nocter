...
| Terminal `if` / `else` | yes | yes | yes | partial | yes | Build supports terminal branches returning direct entry `i32` or `void`, and non-entry `i32`, `u8`, `usize`, `bool`, `void`, `&str`, or u8 slices. |
