...
- optional values
- general aggregate value expressions outside the supported struct-literal, call-result, slot-copy, explicit-move, and borrow paths; arrays, views, pointers, methods, traits, generics, ownership lowering, and drop glue
