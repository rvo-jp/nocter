...
| Scalars and strings | `i32`, `usize`, `u8`, `bool`, `void`, `never`, `&str`, string literals, byte literals, selected arithmetic, comparisons, bool operators, shifts, and runtime trap checks are implemented in the buildable subset. |
