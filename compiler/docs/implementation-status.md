...
- aggregate struct-literal returns and local slots, aggregate call-result slot bindings and assignments, explicit aggregate move bindings, aggregate slot borrow arguments, matching copy-struct or explicit-move slot assignment, and scalar field reads from supported aggregate slots, parameters, and call results
