...
#[test]
fn lowers_optional_i32_if_let_call_terminal_branch() {
    let ir = lower_text(
        r#"func main(): i32 {
...
#[test]
fn lowers_optional_i32_if_let_call_with_fallthrough_success_branch() {
    let ir = lower_text(
        r#"func main(): i32 {
    var result = 0
    if let value = maybe_answer() {
...
#[test]
fn lowers_optional_i32_if_let_call_without_else() {
    let ir = lower_text(
        r#"func main(): i32 {
    var result = 7
    if let value = maybe_answer() {
...
#[test]
fn lowers_optional_i32_if_let_call_with_fallthrough_else_branch() {
    let ir = lower_text(
        r#"func main(): i32 {
    var result = 0
    if let value = maybe_answer() {
